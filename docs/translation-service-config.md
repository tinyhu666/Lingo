...
use `deepseek-ai/DeepSeek-V4-Flash` for the main translation model. This legacy
path does not currently expose the proxy's dual-model fast-lane routing, so it
