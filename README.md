<p align="center">
  <img src="./docs/branding/lingo-readme-header.png" alt="Lingo Header" width="100%" />
</p>

# Lingo - Dota2 游戏内聊天翻译客户端

Lingo 是一个基于 AI 大模型的 Dota2 游戏内聊天翻译工具，面向 Dota2 国际服沟通场景。它加入了 Dota2 专业术语，并针对翻译内容进行润色，更加符合 Dota2 玩家的交流习惯。输入聊天内容后，只需要按下快捷键，即可自动完成翻译，并将翻译后的文本显示在对话窗口中，点击后即可发送翻译后的内容。
